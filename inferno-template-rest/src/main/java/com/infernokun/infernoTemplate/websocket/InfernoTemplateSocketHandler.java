package com.infernokun.infernoTemplate.websocket;
...
import com.infernokun.infernoTemplate.models.StoredObject;
...
@Slf4j
public class InfernoTemplateSocketHandler extends TextWebSocketHandler {
    private final List<WebSocketSession> currentSessions = new CopyOnWriteArrayList<>();
    private final ObjectWriter writer;

    public InfernoTemplateSocketHandler() {
